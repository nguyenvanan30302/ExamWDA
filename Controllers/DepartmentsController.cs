...
namespace asp.net_exam.Controllers
{
    ...
    {
        private readonly aspnet_examContext _context;

        public DepartmentsController(aspnet_examContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Department != null ? 
                          ...
                          Problem("Entity set 'aspnet_examContext.Department'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'aspnet_examContext.Department'  is null.");
            }
            var department = await _context.Department.FindAsync(id);
            if (department != null)
            {
